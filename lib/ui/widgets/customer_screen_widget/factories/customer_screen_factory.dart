...
import '../main_screen/customer_menu_screens/customer_profile_screen/customer_profile_screen_bloc.dart';
...
class CustomerScreenFactory{
  ...
  Widget makeProfileScreen(){
    return BlocProvider<CustomerProfileScreenBloc>(
        create:(_) => CustomerProfileScreenBloc(),
  ...
  Widget makeCustomerRegisterScreen() => CustomerRegisterWidget();
